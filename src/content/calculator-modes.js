...
const common = {
  hy: {
    ...
    pro: {
      ...
      locationCopy: 'Գտեք օբյեկտը քարտեզի վրա կամ մուտքագրեք հասցեն։',
      ...
      useFromMap: 'Օգտագործել քարտեզից',
      environmental: {
  ...
  ru: {
    ...
    pro: {
      ...
      locationCopy: 'Найдите объект на карте или введите адрес.',
  ...
  en: {
    ...
    pro: {
      ...
      locationTitle: 'Location',
      locationCopy: 'Find your property on the map or enter the address.',
