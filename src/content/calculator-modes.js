...
const common = {
  hy: {
    ...
    quick: {
      ...
      tariffOptional: 'Սակագին AMD/kWh (ըստ ցանկության)',
      tariffOptionalHelp: 'Անհրաժեշտ է միայն խնայողությունն ու հետգնման ժամկետը տեսնելու համար։',
  ...
  ru: {
    ...
    quick: {
      ...
      tariffOptional: 'Тариф AMD/kWh (необязательно)',
      tariffOptionalHelp: 'Нужен только для экономии и окупаемости.',
  ...
  en: {
    ...
    quick: {
      ...
      tariffOptional: 'Tariff AMD/kWh (optional)',
      tariffOptionalHelp: 'Only needed for savings and payback.',
