const copy = {
  hy: {
    ...
    pdfReport: {
      ...
      usableArea: 'Մոդուլների օգտակար մակերես',
      physicalModuleLimit: 'Ֆիզիկական մոդուլի սահման',
      physicalCapacity: 'Ֆիզիկական DC հզորության սահման',
      pvgisReferenceYield: 'PVGIS հղումային արտադրություն',
      pvgisReferenceOrientation: 'PVGIS հղումային ուղղություն / թեքություն',
  ...
  ru: {
    ...
    pdfReport: {
      ...
      monthly: 'Помесячная солнечная выработка',
      monthlyLocationReference: 'Эталонная выработка PVGIS по месяцам',
      cashflow: 'Финансовый прогноз',
      limitations: 'Допущения и ограничения',
      property: 'Объект',
      coordinates: 'Координаты',
      consumption: 'Годовое потребление',
      inputMethod: 'Способ ввода потребления',
      ...
      usableArea: 'Полезная площадь для модулей',
      physicalModuleLimit: 'Физический лимит модулей',
      physicalCapacity: 'Физический предел DC-мощности',
      pvgisReferenceYield: 'Эталонная выработка PVGIS',
      pvgisReferenceOrientation: 'Эталонные направление / наклон PVGIS',
  ...
  en: {
    ...
    pdfReport: {
      ...
      monthly: 'Monthly solar production',
      monthlyLocationReference: 'Monthly PVGIS reference yield',
      cashflow: 'Financial outlook',
      limitations: 'Assumptions and limitations',
      property: 'Property',
      coordinates: 'Coordinates',
      consumption: 'Annual consumption',
      inputMethod: 'Consumption input method',
      ...
      usableArea: 'Usable module area',
      physicalModuleLimit: 'Physical module limit',
      physicalCapacity: 'Physical DC capacity limit',
      pvgisReferenceYield: 'PVGIS reference yield',
      pvgisReferenceOrientation: 'PVGIS reference direction / tilt',
      capacity: 'System capacity',
      panels: 'Panels',
      annualProduction: 'Annual generation',
      coverage: 'Consumption coverage',
      coveredConsumption: 'Covered consumption',
      surplus: 'Annual net surplus',
      annualSavings: 'Annual savings',
