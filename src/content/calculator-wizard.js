const copy = {
  hy: {
    ...
    roofCapacityTitle: 'Տանիքի ֆիզիկական տարողություն',
    roofAreaForSizing: 'Տանիքի մակերես',
    preliminaryUsableRoofArea: 'Մոդուլների օգտակար մակերես',
    maximumPanelsForRoof: 'Ֆիզիկական մոդուլի սահման',
    ...
    roofYieldExplanation:
      'Տարբերությունը կարող է պայմանավորված լինել տանիքի իրական ուղղությամբ, թեքությամբ և հաշվարկային ենթադրություններով։',
    roofSummary: 'Տանիք',
    ...
    drawRoof:
      'Նշեք նույն տանիքի առնվազն 3 անկյունը քարտեզի վրա։ Մարկերը կարող եք քաշել՝ դիրքը շտկելու համար, ապա սեղմեք «Ավարտել ուրվագիծը»։',
    ...
    pdfReport: {
      ...
      footerLabel: 'Նախնական արևային հաշվետվություն',
      page2Title: 'Համակարգ, տանիք և էներգիայի հավասարակշռություն',
      page2Subtitle: 'Ինչ է առաջարկվում, ինչքան է թույլ տալիս տանիքը և որքան սպառում է ծածկվում։',
      page3Title: 'Արտադրություն և ֆինանսական պատկեր',
      page3Subtitle: 'Ամսական արևային արտադրությունը և նախնական տնտեսական գնահատումը։',
      page4Title: 'Տվյալներ, աղբյուրներ և սահմանափակումներ',
      page4Subtitle: 'Բոլոր հիմնական տվյալները մեկ տեղում՝ առանց ներքին տեխնիկական կոդերի։',
      recommendedSystem: 'Առաջարկվող համակարգ',
      annualProduction: 'Տարեկան արտադրություն',
      annualCoverage: 'Սպառման տարեկան ծածկույթ',
      annualSavings: 'Տարեկան խնայողություն',
      remainingGridDemand: 'Մնացած պահանջարկ ցանցից',
      co2: 'CO₂ կրճատում',
      perYear: 'տարեկան',
      projectSummary: 'Ձեր նախագծի համառոտ նկարագիրը',
      property: 'Օբյեկտ',
      consumption: 'Սպառում',
      roof: 'Տանիք',
      ...
      disclaimer:
        'Այս հաշվետվությունը նախնական է. վերջնական չափագրումը, ստվերումը, կրողունակությունը, էլեկտրական համատեղելիությունը և առևտրային առաջարկը հաստատվում են ինժեների կողմից։',
      module: 'Արևային մոդուլ',
      inverter: 'Ինվերտեր',
      whyPanels: 'Ինչու {count} մոդուլ',
      sizingExplanation: 'Համակարգը չափագրված է սպառման համար, ոչ թե ամբողջ տանիքը լցնելու։',
      roofCapacityTitle: 'Տանիքի ֆիզիկական կարողություն',
      roofArea: 'Տանիքի մակերես',
      physicalModuleLimit: 'Ֆիզիկական սահման',
      physicalCapacity: 'DC հզորության սահման',
      roofNotLimiting: 'Տանիքը սահմանափակում չէ',
      roofLimiting: 'Տանիքի ֆիզիկական սահմանը սահմանափակում է առաջարկվող համակարգը',
      ...
      payback: 'Հետգնման ժամկետ',
      twentyFiveYears: '25 տարվա կուտակային արժեք',
      budgetRange: 'Նախնական բյուջեի միջակայք',
      centralEstimate: 'Կենտրոնական գնահատական՝ {value}',
      budgetDisclaimer:
      ...
      coordinates: 'Կոորդինատներ',
      inputMethod: 'Մուտքագրման եղանակ',
      tariff: 'Սակագին',
      ...
      sourceUserProvided: 'օգտվողի տվյալ',
      sourcePreliminary: 'նախնական',
      sourceUnavailable: 'անհասանելի',
    ...
    ui: {
      ...
      roof: {
        ...
        outlineRequired:
          'Քարտեզի վրա նշեք նույն տանիքի առնվազն 3 անկյունը, ապա սեղմեք «Ավարտել ուրվագիծը»։',
  ...
  ru: {
    ...
    roofCapacityTitle: 'Физическая вместимость крыши',
    roofAreaForSizing: 'Площадь крыши',
    preliminaryUsableRoofArea: 'Полезная площадь для модулей',
    maximumPanelsForRoof: 'Физический лимит модулей',
    ...
    remainingGridDemand: 'Оставшийся годовой спрос из сети',
    annualNetSurplus: 'Годовая нетто-выработка выше потребления',
    ...
    roofYieldExplanation:
      'Разница может быть вызвана фактической ориентацией, наклоном крыши и расчётными допущениями.',
    roofSummary: 'Крыша',
    roofOrientation: 'Ориентация крыши',
    roofTilt: 'Наклон крыши',
    physicalDcCapacityLimit: 'Физический предел DC-мощности',
    roofCapacityNotLimiting: 'Вместимость крыши не является ограничивающим фактором.',
    ...
    drawRoof:
      'Отметьте на карте минимум 3 угла одной поверхности крыши. Маркеры можно перетаскивать для уточнения позиции, затем нажмите «Завершить контур».',
    ...
    pdfReport: {
      ...
      page4Subtitle: 'Все основные данные в одном месте — без внутренних технических кодов.',
      recommendedSystem: 'Рекомендуемая система',
      annualProduction: 'Годовая выработка',
      annualCoverage: 'Годовое покрытие потребления',
      annualSavings: 'Экономия в год',
      remainingGridDemand: 'Оставшийся спрос из сети',
      co2: 'Сокращение CO₂',
      perYear: 'в год',
      projectSummary: 'Сводка вашего проекта',
      property: 'Объект',
      ...
      disclaimer:
        'Отчёт предварительный: финальные замеры, затенение, несущую способность, электрическую совместимость и коммерческое предложение подтверждает инженер.',
      module: 'Солнечный модуль',
      inverter: 'Инвертор',
      whyPanels: 'Почему {count} модулей',
      sizingExplanation: 'Система подобрана по потреблению, а не для заполнения всей крыши.',
      roofCapacityTitle: 'Физическая вместимость крыши',
      roofArea: 'Площадь крыши',
      physicalModuleLimit: 'Физический предел',
      physicalCapacity: 'Предел DC-мощности',
      roofNotLimiting: 'Крыша не является ограничением',
      roofLimiting: 'Физический предел крыши ограничивает рекомендуемую систему',
      ...
      twentyFiveYears: 'Накопленная экономия за 25 лет',
      budgetRange: 'Предварительный диапазон бюджета',
      centralEstimate: 'Центральная оценка: {value}',
      budgetDisclaimer:
      ...
      sourceUserProvided: 'данные пользователя',
      sourcePreliminary: 'предварительно',
      ...
      inputModes: {
        ...
        upload: 'Прикреплённый счёт'
      },
      unavailable: 'Недоступно',
      years: 'лет',
      kwhPerYear: 'kWh/год',
      yieldPerYear: 'kWh/kWp/год',
      amdPerYear: 'AMD/год',
      modulesWord: 'модулей',
    ...
    ui: {
      ...
      roof: {
        ...
        outlineRequired:
          'Отметьте на карте минимум 3 угла одной поверхности крыши, затем нажмите «Завершить контур».',
  ...
  en: {
    ...
    roofAreaForSizing: 'Roof area',
    preliminaryUsableRoofArea: 'Usable module area',
    maximumPanelsForRoof: 'Physical module limit',
    ...
    roofTilt: 'Roof tilt',
    physicalDcCapacityLimit: 'Physical DC capacity limit',
    roofCapacityNotLimiting: 'Roof capacity is not a limiting factor.',
    ...
    drawRoof:
      'Mark at least 3 corners of one roof surface on the map. Drag markers to refine their positions, then select Finish outline.',
    ...
    pdfReport: {
      ...
      page4Subtitle: 'All key calculation data in one place, without internal technical codes.',
      recommendedSystem: 'Recommended system',
      annualProduction: 'Annual production',
      annualCoverage: 'Annual consumption coverage',
      annualSavings: 'Annual savings',
      remainingGridDemand: 'Remaining grid demand',
      co2: 'CO₂ reduction',
      perYear: 'per year',
      ...
      disclaimer:
        'This report is preliminary. Final measurements, shading, structural capacity, electrical compatibility and the commercial offer are confirmed by an engineer.',
      module: 'Solar module',
      inverter: 'Inverter',
      ...
      physicalCapacity: 'DC capacity limit',
      roofNotLimiting: 'Roof capacity is not a limiting factor',
      roofLimiting: 'The physical roof limit constrains the recommended system',
      ...
      twentyFiveYears: '25-year cumulative value',
      budgetRange: 'Preliminary budget range',
      centralEstimate: 'Central estimate: {value}',
      budgetDisclaimer:
    ...
    ui: {
      ...
      roof: {
        ...
        outlineRequired:
          'Mark at least 3 corners of one roof surface on the map, then select Finish outline.',
