const copy = {
  hy: {
    ...
    maximumPanelsForRoof: 'Առավելագույնը՝ ըստ ընտրված մոդուլի',
  ...
  ru: {
    ...
    maximumPanelsForRoof: 'Максимум по выбранному модулю',
  ...
  en: {
    ...
    maximumPanelsForRoof: 'Maximum with the selected module',
