...
export const BASE_PROFILE = Object.freeze({
  ...
  keywords: [],
  location: {
    hy: 'Երևան · ստանդարտ դեմո պրոֆիլ',
    ru: 'Ереван · стандартный демо-профиль',
    en: 'Yerevan · standard demo profile'
  },
  roof: {
    areaSqm: 124,
    orientation: 236,
    orientationLabel: {
      hy: 'Հարավ-արևմուտք (236°)',
      ru: 'Юго-запад (236°)',
      en: 'South-west (236°)'
    },
    tilt: 32
...
const DEMO_PROFILES = Object.freeze([
  ...
  createProfile({
    ...
    location: {
      hy: 'Երևան, Արաբկիր · դեմո պրոֆիլ',
      ru: 'Ереван, Арабкир · демо-профиль',
      en: 'Yerevan, Arabkir · demo profile'
    },
  ...
  createProfile({
    ...
    location: {
      hy: 'Աբովյան · դեմո պրոֆիլ',
      ru: 'Абовян · демо-профиль',
      en: 'Abovyan · demo profile'
    },
    roof: {
      areaSqm: 96,
      orientation: 212,
      orientationLabel: { hy: 'Հարավ (212°)', ru: 'Юг (212°)', en: 'South (212°)' },
      tilt: 29
    },
  ...
  createProfile({
    ...
    location: {
      hy: 'Արարատ · դեմո պրոֆիլ',
      ru: 'Арарат · демо-профиль',
      en: 'Ararat · demo profile'
    },
    roof: {
      areaSqm: 148,
      orientation: 222,
      orientationLabel: {
        hy: 'Հարավ-արևմուտք (222°)',
        ru: 'Юго-запад (222°)',
        en: 'South-west (222°)'
      },
      tilt: 30
...
export const buildAnalysis = (profile = BASE_PROFILE, { locale = 'ru' } = {}) => {
  ...
  return {
    ...
    location: {
      label: selected.location[localeKey] ?? selected.location.ru,
      geocoded: false
    },
    roof: {
      ...
      orientationLabel:
        selected.roof.orientationLabel[localeKey] ?? selected.roof.orientationLabel.ru,
